...
//针对按键进行的监控
        ...
        ImageButton bozhongzuoye = findViewById(R.id.Bozhongzuoye);
        //
        bozhongzuoye.setOnClickListener(v -> {
        ...
        ImageButton machine_watch = findViewById(R.id.Machine_watch);
        //
        machine_watch.setOnClickListener(v -> {
            // 创建一个Intent对象，指定当前Activity和目标Activity的类
        ...
        //3 针对种子监控
        ImageButton seed_watch = findViewById(R.id.seed_watch);
        //
        seed_watch.setOnClickListener(v -> {
            // 创建一个Intent对象，指定当前Activity和目标Activity的类
        ...
        //  5  home
        ImageButton back_home = findViewById(R.id.setting_back);
        //
